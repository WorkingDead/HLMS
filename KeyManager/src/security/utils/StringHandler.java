...
public final class StringHandler {
     ...
     * {@code "new StringHandler(new long[] {
    ...
    public static String obfuscate(final String s) {
        ...
        // StringHandler unless it's no longer than two characters.
        // This should help to prevent location of this class in the obfuscated
        // code generated by ProGuard.

        if (-1 != s.indexOf(0)) {
            throw new IllegalArgumentException(new StringHandler(new long[] {
        ...
        // Add time to increase the randomization
        ...
        final StringBuffer code = new StringBuffer(new StringHandler(new long[] {
        		0xA7318C4D8EA41F79L, 0xB2E6C11AA67CB638L, 
        		0x68B2110EF8379F15L, 0xE59E4325B95B5DE0L, 
        		0x7CAF25EDC7923BF4L
        		}).toString()); // => "new StringHandler(new long[] {";
        ...
        code.append(new StringHandler(new long[] {
        ...
        code.append(
                s.replaceAll("\\\\", new StringHandler(new long[] {
                    0x6D2C680D49523A01L, 0xB932F1DBD19E82CEL}).toString() /* => "\\\\\\\\" */)
                .replaceAll("\"", new StringHandler(new long[] {
     ...
     */
    public StringHandler(final long[] obfuscated) {
