...
<!-- ################################################## -->
	<fieldset id="rfidCaptureSummaryFieldset" name="rfidCaptureSummaryFieldset" class="fieldsetStyle02">
...
$(function() {
	...
	<s:url var="validatePageSchedulerUrl" namespace="/kiosk" action="3.
	" method="checkPageMaster"></s:url>
	function validatePageScheduler()
	{
		var targetUrl = '<s:property value="#validatePageSchedulerUrl"/>';
