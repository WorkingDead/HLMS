...
<div class="pagingStyle01">
	<s:property escape="false" value="page.getPagination('ajaxSearchDialogFormPage', 'ajaxSearchJumpDialogFormPage')"/>
</div>
	...
	<tbody>
		...
		<s:iterator value="transactionList">
			<tr>
				...
				<td><s:property value="%{getText(transactionName.value)}" escape="false"/></td>
