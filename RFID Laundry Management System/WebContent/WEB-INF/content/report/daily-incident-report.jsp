...
<h3 class="fnName"><s:text name="page.title.daily.incident.report" /></h3>
...
<div class="body">
	<s:form theme="simple" namespace="/report" action="daily-incident-report" method="post" target="_blank">
		<fieldset id="searchFieldset" name="searchFieldset" class="fieldsetStyle01">
			...
			<ul>
				<li>
					<label for="dateFrom"><s:text name="label.date"/>:</label>
					<s:textfield theme="simple" name="dateFrom" cssClass="inputText dateTimePicker"/>
				</li>
