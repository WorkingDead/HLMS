...
<h3 class="fnName"><s:text name="page.title.monthly.laundry.dist.report" /></h3>
...
<div class="body">
	<s:form theme="simple" namespace="/report" action="monthly-laundry-dist-report" method="post" target="_blank">
