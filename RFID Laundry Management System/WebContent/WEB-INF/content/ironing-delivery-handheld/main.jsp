...
<div class="body">
	<s:form theme="simple" id="addFrom" namespace="/general" action="ironing-delivery-handheld" method="post" cssClass="ajaxForm">
...
<!-- ################################################## -->
	<fieldset id="rfidCaptureDetailFieldset" name="rfidCaptureDetailFieldset" class="fieldsetStyle01">
		...
		<div class="alignRight">
			<s:url var="removeClothUrl" action="ironing-delivery-handheld" method="ajaxRemoveRfid"></s:url>
				...
				<tbody>
					<s:iterator value="clothList">
						<tr id="RFIDTable_row_<s:property value="rfid"/>">
							...
							<td><s:property value="lastRollContainerCode"/></td>
...
// 	validatePageScheduler();
	...
	<s:url var="resetReceiptUrl" namespace="/general" action="ironing-delivery-handheld" method="resetReceipt"></s:url>
	...
	<s:url var="getCapturedRfidJsonUrl" namespace="/general" action="ironing-delivery-handheld" method="getCapturedRfidJson"></s:url>
...
// 	<s:url var="validatePageSchedulerUrl" namespace="/general" action="ironing-delivery-handheld" method="checkPageMaster"></s:url>
...
// 			}
			...
			row.append($("<td/>").text(value.lastRollContainerCode));
	...
	/////////////////////////////////////////////////////////////////
	<s:url var="getNewPageUrl" namespace="/general" action="ironing-delivery-handheld" method="getMainPage" />
