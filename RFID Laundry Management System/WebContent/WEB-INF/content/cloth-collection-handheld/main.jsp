...
<h3 class="fnName"><s:text name="page.title.cloth.collect.handheld" /></h3>
<div class="body">
	<s:form theme="simple" id="addFrom" namespace="/general" action="cloth-collection-handheld" method="post" cssClass="ajaxForm">
...
<!-- ################################################## -->
	<fieldset id="rfidCaptureDetailFieldset" name="rfidCaptureDetailFieldset" class="fieldsetStyle01">
		...
		<div class="alignRight">
			<s:url var="removeClothUrl" action="cloth-collection-handheld" method="ajaxRemoveRfid"></s:url>
...
// 	validatePageScheduler();
	...
	<s:url var="resetReceiptUrl" namespace="/general" action="cloth-collection-handheld" method="resetReceipt"></s:url>
	...
	<s:url var="getCapturedRfidJsonUrl" namespace="/general" action="cloth-collection-handheld" method="getCapturedRfidJson"></s:url>
...
// 	<s:url var="validatePageSchedulerUrl" namespace="/general" action="cloth-collection-handheld" method="checkPageMaster"></s:url>
...
// 			}
	...
	/////////////////////////////////////////////////////////////////
	<s:url var="getNewPageUrl" namespace="/general" action="cloth-collection-handheld" method="getMainPage" />
