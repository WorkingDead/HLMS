...
<table class="dataTable">
	...
	<tbody>
		<s:if test="clothList == null || clothList.size == 0">
			<tr>
				<td colspan="10"><s:text name="list.nothing.found"/></td>
			</tr>
		</s:if>

		<s:iterator value="clothList">
			<tr>
				<td><s:checkbox name="cloth.id" fieldValue="%{id}" theme="simple" cssClass="checkall2 simpleCheckBox selectedClothMarker" checkall="cbCheckAll"></s:checkbox></td>
