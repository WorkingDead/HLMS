...
<h3 class="fnName"><s:text name="page.title.cloth.association.handheld" /></h3>
<div class="body">
	<s:form theme="simple" id="addFrom" namespace="/general" action="cloth-association-handheld" method="post" cssClass="ajaxForm">
		<fieldset id="btnOnlyFieldset" name="btnOnlyFieldset" class="fieldsetStyle01">
			<legend><s:text name="fieldset.legend.cloth.save"/></legend>
...
<!-- ################################################## -->
	<fieldset id="rfidCaptureDetailFieldset" name="rfidCaptureDetailFieldset" class="fieldsetStyle01">
		...
		<div class="alignRight">
			<s:url var="removeClothUrl" action="cloth-association-handheld" method="ajaxRemoveRfid"></s:url>
...
// 	validatePageScheduler();
	...
	<s:url var="resetPageUrl" namespace="/general" action="cloth-association-handheld" method="resetPage"></s:url>
	$("#ajaxBtnReceiptReset").on("click", function() {
		...
		optionsAvailableMsgDialog(
				...
				{
					$.ajax({
						url: '<s:property value="#resetPageUrl"/>',
						success: function()
						{
	...
	<s:url var="getCapturedRfidJsonUrl" namespace="/general" action="cloth-association-handheld" method="getCapturedRfidJson"></s:url>
		...
		if (isActionValid)
		{
			$.ajax({
				...
				success: function(result) {
					// 2.1. update cloth-total
					$("#RFIDTotal tbody tr td").val(result.clothTotal);
...
// 	<s:url var="validatePageSchedulerUrl" namespace="/general" action="cloth-association-handheld" method="checkPageMaster"></s:url>
...
// 	}
	...
	/////////////////////////////////////////////////////////////////
	<s:url var="getNewPageUrl" namespace="/general" action="cloth-association-handheld" method="getMainPage" />
