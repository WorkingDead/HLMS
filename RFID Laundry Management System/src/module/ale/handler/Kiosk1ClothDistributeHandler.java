...
@Component(Kiosk1ClothDistributeHandler.BEANNAME)
public class Kiosk1ClothDistributeHandler extends CaptureButtonBaseHandler implements ECSpecHandler
{
	private static final Logger log4j = Logger.getLogger(Kiosk1ClothDistributeHandler.class);
	
	public static final String BEANNAME = "Kiosk1ClothDistributeHandler";
	public static final String SPECNAME = "Kiosk1ClothDistributeHandler";
