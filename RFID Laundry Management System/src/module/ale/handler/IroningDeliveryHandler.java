...
public class IroningDeliveryHandler extends CaptureButtonBaseHandler implements ECSpecHandler
{
	private static final Logger log4j = Logger.getLogger(IroningDeliveryHandler.class);
	
	public static final String BEANNAME = "IroningDeliveryHandler";
	public static final String SPECNAME = "IroningDeliveryHandler";
