...
@Component(Kiosk1ClothCollectionHandler.BEANNAME)
public class Kiosk1ClothCollectionHandler extends CaptureButtonBaseHandler implements ECSpecHandler
{
	private static final Logger log4j = Logger.getLogger(Kiosk1ClothCollectionHandler.class);
	
	public static final String BEANNAME = "Kiosk1ClothCollectionHandler";
	public static final String SPECNAME = "Kiosk1ClothCollectionHandler";
