...
public class AioReceiptExporter extends BaseActionGeneral
{
	private static final long serialVersionUID = 3157110574560513410L;
	private static final Logger log4j = Logger.getLogger(AioReceiptExporter.class);
	
	// iReport Receipt exporting
	...
	public AioReceiptExporter(HttpServletResponse hsr)
	{
		this.response = hsr;
	}
	
	public void exportCollectReceipt(Receipt receipt, String reportFilePath, String subreportPath) throws Exception
	{
		/////////////////////////////////////////////
		// 1. Preparing receipt data for exporting
		/////////////////////////////////////////////
		// iReport setting
		...
		JRBeanCollectionDataSource dataSrc = new JRBeanCollectionDataSource(this.mainReportList);
		JasperPrint jasperPrint = JasperFillManager.fillReport(reportFilePath, parameters, dataSrc);
		
		////////////////////////////////
		// Gen PDF for browser
		////////////////////////////////
		this.generatePdfFile(jasperPrint);
...
//		ouputStream.close();
	...
	public void exportIroningReceipt(Receipt receipt, String reportFilePath, String subreportPath) throws Exception
	{
		/////////////////////////////////////////////
		// 1. Preparing receipt data for exporting
		/////////////////////////////////////////////
...
//		String staffNameHandledBy = receipt.getStaffHandledBy().getNameCht();
	...
	public void exportRackingReceipt(Receipt receipt, String reportFilePath, String subreportPath) throws Exception
	{
		/////////////////////////////////////////////
		// 1. Preparing receipt data for exporting
		/////////////////////////////////////////////
	...
	public void exportDistReceipt(Receipt receipt, String reportFilePath, String subreportPath) throws Exception
	{
		/////////////////////////////////////////////
		// 1. Preparing receipt data for exporting
		/////////////////////////////////////////////
	...
	private void generatePdfFile(JasperPrint jasperPrint)
	{
		/////////////////////////////////////////////
		...
		byte b[] = new byte[0];
		response.setContentType("application/pdf");
		// response.setHeader("Content-Disposition", "attachment; filename=exported.pdf");	// this line force the browser open a popup windows to download
		try
		{
			b = JasperExportManager.exportReportToPdf(jasperPrint);
			response.setContentLength(b.length);
