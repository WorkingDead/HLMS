...
public class ClothDistributeAction extends BaseActionSecurity {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2723458500081245309L;

	
		private static final Logger log4j = Logger.getLogger(ClothDistributeAction.class);
		
		// Session
		private static final String SESSION_KEY_USER = "DISTRIBUTE_BY_USER";
		...
		public void resetReceipt()
		{
			...
			this.resetSessionVariables(SESSION_KEY_USER);
		...
		public synchronized String getCapturedRfidJson()
		{
			...
			try
			{
				this.clothTypeCountList = this.updateKioskClothTypeCountMap(SESSION_KEY_USER, this.clothList);
			}
			catch (Exception e)
			{
				e.printStackTrace();
