...
public class SimulateHandheldSendToClothRackingHandler {

	@Test(timeout = 2000)
	public void Test01() {
		
		EventParameter eventParameter1 = new EventParameter();
		eventParameter1.setName( "location_code" );
		eventParameter1.setValue( "Z1" );
		...
		handheldEvent.setEventName( ClothRackingHandler.EVENT_NAME );
