...
public class ImportDeptAppendToTheEndWhenNotExist {
	...
	{
		System.out.println("###############################################");
		System.out.println("Importing Departments AppendToTheEndWhenNotExist");
		System.out.println("###############################################");
		...
		for (int i = 0; i < deptArray.length; i++)
		{
			...
			CustomCriteriaHandler<Department> customCriteriaHandler = searchDepartmentCriteria( nameEng, nameCht );
			int n = masterService.totalByExample(Department.class, null, customCriteriaHandler);
			if ( n <= 0 ) {
				saveList.add(dept);
	...
	private CustomCriteriaHandler<Department> searchDepartmentCriteria(final String nameEng, final String nameCht) {
