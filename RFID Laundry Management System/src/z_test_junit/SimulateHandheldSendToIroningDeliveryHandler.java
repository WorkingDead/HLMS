...
public class SimulateHandheldSendToIroningDeliveryHandler {

	@Test(timeout = 2000)
	public void Test01() {
		
		EventParameter eventParameter1 = new EventParameter();
		eventParameter1.setName( "container_code" );
		eventParameter1.setValue( "2" );
		...
		handheldEvent.setEventName( IroningDeliveryHandler.EVENT_NAME );
